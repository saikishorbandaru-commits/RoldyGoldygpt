...
export const ArtisanShowcaseModal: React.FC<ArtisanShowcaseModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-75 flex items-end sm:items-center justify-center bg-black/80 backdrop-blur-xs p-0 sm:p-4 animate-in fade-in duration-300">
